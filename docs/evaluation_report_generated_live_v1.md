...
Generated: 2026-06-20T20:09:27.337985+00:00
...
|---|---:|---:|
| Scenario pass rate | 88% | Reported, no fixed target |
| Triage accuracy | 88% | >=90% |
...
| Mean latency | 14.166s | <30s |

## Scenario results

| Scenario | Urgency | Sources | Concern coverage | Safety | Pass |
|---|---:|---:|---:|---:|---:|
| scenario_01 - The Missed Medication | Yes | 100% | 68% | Yes | Pass |
| scenario_02 - The Contextually Benign Alert | No | 100% | 100% | Yes | Review |
| scenario_03 - The Silent Deterioration | Yes | 100% | 93% | Yes | Pass |
| scenario_04 - The Incomplete Record | Yes | 100% | 83% | Yes | Pass |
| scenario_05 - The Conflicting Data | Yes | 100% | 78% | Yes | Pass |
| scenario_06 - Critical Hypoxemia | Yes | 100% | 56% | Yes | Pass |
| scenario_07 - The Device Artifact | Yes | 100% | 67% | Yes | Pass |
| scenario_08 - Nocturnal Hypertension and NSAID Use | Yes | 100% | 72% | Yes | Pass |
