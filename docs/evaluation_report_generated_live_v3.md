...
Generated: 2026-06-20T20:15:02.742463+00:00
...
|---|---:|---:|
| Scenario pass rate | 75% | Reported, no fixed target |
| Triage accuracy | 75% | >=90% |
...
| Mean latency | 14.537s | <30s |

## Scenario results

| Scenario | Urgency | Sources | Concern coverage | Safety | Pass |
|---|---:|---:|---:|---:|---:|
| scenario_01 - The Missed Medication | Yes | 100% | 78% | Yes | Pass |
| scenario_02 - The Contextually Benign Alert | No | 100% | 83% | Yes | Review |
| scenario_03 - The Silent Deterioration | Yes | 100% | 78% | Yes | Pass |
| scenario_04 - The Incomplete Record | No | 100% | 89% | Yes | Review |
