...
This run evaluates the deterministic offline pathway so the result is reproducible without sending any data to an external API. It validates orchestration, safety routing, source traceability, retrieval coverage, and output contracts.
